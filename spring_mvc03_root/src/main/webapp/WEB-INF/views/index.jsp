...
<script type="text/javascript">
	...
	function websocket_go() {
		location.href="chat.do";
	}
	function websocket_go2() {
		location.href="chat2.do";
	}
	function websocket_go3() {
...
<body>
	...
	<button onclick="websocket_go()">웹소켓</button>
	<button onclick="websocket_go2()">웹소켓(stomp)</button>
	<button onclick="websocket_go3()">채팅방(stomp)</button>
</body>
</html>
